...
<img src="/assets/systems/icons/cplus4.webp" alt="Commodore Plus4 icon" width="96" height="96" loading="lazy" style="border-radius:12px; object-fit:contain; background:#0f172a; padding:.25rem;">
<span style="display:flex; align-items:center; justify-content:center; background:#050505; padding:.35rem 0.75rem; border-radius:0.75rem;"><img src="/assets/systems/logos/cplus4.png" alt="Commodore Plus4 logo" loading="lazy" style="max-height:96px; object-fit:contain;"></span>
</div>
...
The default Plus/4 layout maps to the [REG-Linux Retropad](/configure_a_controller). Use VICE or RetroArch’s input configuration for title-specific adjustments.
