...
<span style="display:flex; align-items:center; justify-content:center; background:#050505; padding:.35rem 0.75rem; border-radius:0.75rem;"><img src="/assets/systems/logos/systemsp.png" alt="Sega System SP logo" loading="lazy" style="max-height:96px; object-fit:contain;"></span>
</div>

## Overview

Introduced in 2004 by Sega, the Sega System SP was a arcade system. Its platform tag is `systemsp, arcade` for proper filtering.
