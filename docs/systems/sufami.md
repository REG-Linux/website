...
<span style="display:flex; align-items:center; justify-content:center; background:#050505; padding:.35rem 0.75rem; border-radius:0.75rem;"><img src="/assets/systems/logos/sufami.png" alt="SuFami Turbo logo" loading="lazy" style="max-height:96px; object-fit:contain;"></span>
</div>

## Overview

Introduced in 1996 by Bandai, the SuFami Turbo was a console system. It is grouped with snes titles in EmulationStation.
