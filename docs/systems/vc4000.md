...
<span style="display:flex; align-items:center; justify-content:center; background:#050505; padding:.35rem 0.75rem; border-radius:.75rem;"><img src="/assets/systems/logos/vc4000.png" alt="VC 4000 logo" loading="lazy" style="max-height:96px; object-fit:contain;"></span>
</div>
...
VC 4000 games rely on simple joystick/button input; use the default arcade overlay or save a remap when needed. If a ROM refuses to boot, verify the extension and keep the archive flattened. For general questions consult the [generic support pages](/support).
