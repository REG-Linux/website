...
<span style="display:flex; align-items:center; justify-content:center; background:#050505; padding:.35rem 0.75rem; border-radius:.75rem;"><img src="/assets/systems/logos/pokemini.png" alt="Pokemon Mini logo" loading="lazy" style="max-height:96px; object-fit:contain;"></span>
</div>
...
- Consult the [generic support pages](/support) for more guidance.
