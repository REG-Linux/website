...
The ColecoVision controller had a numeric keypad plus joystick and action buttons; the default mapping is shown on a [REG-Linux Retropad](/configure_a_controller):
