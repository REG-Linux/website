...
<span style="display:flex; align-items:center; justify-content:center; background:#050505; padding:.35rem 0.75rem; border-radius:.75rem;"><img src="/assets/systems/logos/pv1000.png" alt="PV-1000 logo" loading="lazy" style="max-height:96px; object-fit:contain;"></span>
</div>
...
- Consult the [generic support pages](/support) or the [arcade guide’s MAME troubleshooting section](/systems/mame#troubleshooting) if a title misbehaves.
