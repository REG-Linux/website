...
The standard CD-i controller mapping overlays on a [REG-Linux Retropad](/configure_a_controller):
...
- For driver-specific issues, consult the [MAME troubleshooting section](/systems/mame#troubleshooting).
