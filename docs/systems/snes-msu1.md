...
<span style="display:flex; align-items:center; justify-content:center; background:#050505; padding:.35rem 0.75rem; border-radius:.75rem;"><img src="/assets/systems/logos/snes-msu1.png" alt="Super Disc System (MSU1) logo" loading="lazy" style="max-height:96px; object-fit:contain;"></span>
</div>
...
- For general RetroArch help see the [generic support pages](/support).
