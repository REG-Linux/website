...
The default Commodore 128 inputs map to a [REG-Linux Retropad](/configure_a_controller). The overlay highlights the joystick buttons, keyboard shortcuts and hotkeys used by the system.
