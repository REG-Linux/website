...
RetroArch exposes the usual `x68000.*` settings plus a handful of px68k-specific options. Use the Quick Menu (`[HOTKEY]` + ![south](/wiki/south.png)) to change the display mode, enable shaders, and tweak the CPU speed if a title becomes sluggish.
...
- For general input or RetroArch hints, consult the [generic support pages](/support).
