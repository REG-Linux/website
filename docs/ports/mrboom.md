...
The MrBoom is a port platform developed by Ports. It is grouped with ports titles in EmulationStation. Its platform tag is `pc` for proper filtering.
...
- **mrboom** (libretro) – Requires BR2_PACKAGE_LIBRETRO_MRBOOM
