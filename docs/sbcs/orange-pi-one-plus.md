...
| SoC | CPU | GPU |
| --- | --- | --- |
| Allwinner H6 | ARM Cortex-A53 (Quad-core) | Mali-T720 MP2 |
...
1. Grab the image. Download the latest Orange Pi One Plus build from the downloads page or the official board entry .
...
- Official REG Linux board page: https://reglinux.org/board/orange-pi-one-plus
