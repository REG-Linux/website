...
| SoC | CPU | GPU |
| --- | --- | --- |
| Allwinner H3 | ARM Cortex-A7 (Quad-core) | Mali-400 MP2 |
...
1. Grab the image. Download the latest Orange Pi Plus 2E build from the downloads page or the official board entry .
...
3. First boot setup. Insert the media into your Orange Pi Plus 2E, power on, and let REG Linux expand the filesystem. Pair controllers inside EmulationStation once prompted.
...
- REG Linux download page: https://reglinux.org/download/orange-pi-plus-2e/

- Official REG Linux board page: https://reglinux.org/board/orange-pi-plus-2e
