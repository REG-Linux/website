...
1. Grab the image. Download the latest Orange Pi PC build from the downloads page or the official board entry .
...
- Official REG Linux board page: https://reglinux.org/board/orange-pi-pc
