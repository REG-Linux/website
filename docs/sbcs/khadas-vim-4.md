...
| SoC | CPU | GPU |
| --- | --- | --- |
| Amlogic A311D2 | ARM Cortex-A73/A53 (Hexa-core) | Mali-G52 MP4 |
...
1. Grab the image. Download the latest Khadas VIM 4 build from the downloads page or the official board entry .
...
3. First boot setup. Insert the media into your Khadas VIM 4, power on, and let REG Linux expand the filesystem. Pair controllers inside EmulationStation once prompted.
...
- REG Linux download page: https://reglinux.org/download/khadas-vim-4/

- Official REG Linux board page: https://reglinux.org/board/khadas-vim-4
