...
description: Asus Tinker Board (S) pairs the Rockchip RK3288 SoC with the REG Linux
  stack for a polished retro console. pairs the Rockchip RK3288 SoC with the REG Linux
  s...
---

# Asus Tinker Board (S)

Asus Tinker Board (S) pairs the Rockchip RK3288 SoC with the REG Linux stack for a polished retro console. pairs the Rockchip RK3288 SoC with the REG Linux stack for a polished retro console.
...
1. Grab the image. Download the latest Asus Tinker Board (S) build from the downloads page or the official board entry .
...
3. First boot setup. Insert the media into your Asus Tinker Board (S), power on, and let REG Linux expand the filesystem. Pair controllers inside EmulationStation once prompted.
...
- REG Linux download page: https://reglinux.org/download/asus-tinker-board-s/

- Official REG Linux board page: https://reglinux.org/board/asus-tinker-board-s
