...
1. Grab the image. Download the latest Firefly Station P2 / ROC-RK3568-PC build from the downloads page or the official board entry .
...
- Official REG Linux board page: https://reglinux.org/board/firefly-station-p2-roc-rk3568-pc
