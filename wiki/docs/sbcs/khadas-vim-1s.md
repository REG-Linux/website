---
title: Khadas VIM 1S
description: Khadas VIM 1S pairs the Amlogic S905Y4 SoC with the REG Linux stack for
  a polished retro console. pairs the Amlogic S905Y4 SoC with the REG Linux stack
  for a...
---

# Khadas VIM 1S

Khadas VIM 1S pairs the Amlogic S905Y4 SoC with the REG Linux stack for a polished retro console. pairs the Amlogic S905Y4 SoC with the REG Linux stack for a polished retro console.
...
| SoC | CPU | GPU |
| --- | --- | --- |
| Amlogic S905Y4 | ARM Cortex-A55 (Quad-core) | Mali-G31 MP2 |
...
1. Grab the image. Download the latest Khadas VIM 1S build from the downloads page or the official board entry .
...
3. First boot setup. Insert the media into your Khadas VIM 1S, power on, and let REG Linux expand the filesystem. Pair controllers inside EmulationStation once prompted.
...
- REG Linux download page: https://reglinux.org/download/khadas-vim-1s/

- Official REG Linux board page: https://reglinux.org/board/khadas-vim-1s
