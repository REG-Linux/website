...
description: Raspberry Pi 400 pairs the Broadcom BCM2711 SoC with the REG Linux stack for a polished retro console.
generated: 2026-03-18 22:04:15
---

# Raspberry Pi 400

Raspberry Pi 400 pairs the Broadcom BCM2711 SoC with the REG Linux stack for a polished retro console.


## Hardware & Compatibility

<div data-reg-compat="raspberry-pi-400:specs"></div>
<script src="https://compat.reglinux.org/widget.js"></script>

## Installation notes

1. Grab the image. Download the latest Raspberry Pi 400 build from the downloads page.
