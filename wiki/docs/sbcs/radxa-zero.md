---
title: Radxa Zero
description: Radxa Zero pairs the Amlogic S905Y2 SoC with the REG Linux stack for
  a polished retro console. pairs the Amlogic S905Y2 SoC with the REG Linux stack
  for a po...
---
