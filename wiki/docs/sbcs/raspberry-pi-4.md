...
description: Raspberry Pi 4 pairs the Broadcom BCM2711 SoC with the REG Linux stack
...
Raspberry Pi 4 pairs the Broadcom BCM2711 SoC with the REG Linux stack for a polished retro console. pairs the Broadcom BCM2711 SoC with the REG Linux stack for a polished retro console.
...
| SoC | CPU | GPU |
| --- | --- | --- |
| Broadcom BCM2711 | ARM Cortex-A72 (Quad-core) | VideoCore VI |
...
1. Grab the image. Download the latest Raspberry Pi 4 build from the downloads page or the official board entry .
...
3. First boot setup. Insert the media into your Raspberry Pi 4, power on, and let REG Linux expand the filesystem. Pair controllers inside EmulationStation once prompted.
...
- REG Linux download page: https://reglinux.org/download/raspberry-pi-4/

- Official REG Linux board page: https://reglinux.org/board/raspberry-pi-4
