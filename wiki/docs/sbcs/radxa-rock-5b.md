---
title: Radxa Rock 5B
description: Radxa Rock 5B pairs the Rockchip RK3588 SoC with the REG Linux stack
...
Radxa Rock 5B pairs the Rockchip RK3588 SoC with the REG Linux stack for a polished retro console. pairs the Rockchip RK3588 SoC with the REG Linux stack for a polished retro console.
...
1. Grab the image. Download the latest Radxa Rock 5B build from the downloads page or the official board entry .
...
3. First boot setup. Insert the media into your Radxa Rock 5B, power on, and let REG Linux expand the filesystem. Pair controllers inside EmulationStation once prompted.
...
- REG Linux download page: https://reglinux.org/download/radxa-rock-5b/

- Official REG Linux board page: https://reglinux.org/board/radxa-rock-5b
