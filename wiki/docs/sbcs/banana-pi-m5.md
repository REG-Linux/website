...
1. Grab the image. Download the latest Banana Pi M5 build from the downloads page or the official board entry .
...
3. First boot setup. Insert the media into your Banana Pi M5, power on, and let REG Linux expand the filesystem. Pair controllers inside EmulationStation once prompted.
...
- REG Linux download page: https://reglinux.org/download/banana-pi-m5/

- Official REG Linux board page: https://reglinux.org/board/banana-pi-m5
