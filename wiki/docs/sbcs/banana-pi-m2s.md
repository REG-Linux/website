...
1. Grab the image. Download the latest Banana Pi M2S build from the downloads page or the official board entry .
...
- Official REG Linux board page: https://reglinux.org/board/banana-pi-m2s
