---
title: Khadas VIM 3
description: Khadas VIM 3 pairs the Amlogic A311D SoC with the REG Linux stack for
...
Khadas VIM 3 pairs the Amlogic A311D SoC with the REG Linux stack for a polished retro console. pairs the Amlogic A311D SoC with the REG Linux stack for a polished retro console.
...
1. Grab the image. Download the latest Khadas VIM 3 build from the downloads page or the official board entry .
...
3. First boot setup. Insert the media into your Khadas VIM 3, power on, and let REG Linux expand the filesystem. Pair controllers inside EmulationStation once prompted.
...
- REG Linux download page: https://reglinux.org/download/khadas-vim-3/

- Official REG Linux board page: https://reglinux.org/board/khadas-vim-3
