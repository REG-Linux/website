...
| Image availability | Download the latest build from the REG Linux downloads hub (Koch Media section). |
...
1. Grab the image. Download the latest Capcom Home Arcade build from the downloads page or the official board entry .
...
- Official REG Linux board page: https://reglinux.org/board/capcom-home-arcade
