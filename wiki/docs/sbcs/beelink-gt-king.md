...
description: Beelink GT King pairs the Amlogic S922X SoC with the REG Linux stack for a polished retro console.
generated: 2026-03-18 12:01:02
---

# Beelink GT King

Beelink GT King pairs the Amlogic S922X SoC with the REG Linux stack for a polished retro console.
...
1. Grab the image. Download the latest Beelink GT King build from the downloads page.
