...
| SoC | CPU | GPU |
| --- | --- | --- |
| Amlogic S905D3 | ARM Cortex-A55 (Quad-core) | Mali-G31 MP2 |
...
1. Grab the image. Download the latest Khadas VIM 3L build from the downloads page or the official board entry .
...
- Official REG Linux board page: https://reglinux.org/board/khadas-vim-3l
