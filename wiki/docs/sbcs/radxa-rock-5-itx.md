...
<div data-reg-compat="radxa-rock-5-itx:specs"></div>
<script src="https://compat.reglinux.org/widget.js"></script>

## Installation notes

1. Grab the image. Download the latest Radxa 5 Itx build from the downloads page.
...
3. First boot setup. Insert the media into your Radxa 5 Itx, power on, and let REG Linux expand the filesystem. Pair controllers inside EmulationStation once prompted.

## Resources

- REG Linux download page: https://reglinux.org/download/radxa-rock-5-itx/
