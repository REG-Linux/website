...
| SoC | CPU | GPU |
| --- | --- | --- |
| Allwinner H5 | ARM Cortex-A53 (Quad-core) | Mali-450 MP4 |
...
1. Grab the image. Download the latest Orange Pi PC 2 build from the downloads page or the official board entry .
...
3. First boot setup. Insert the media into your Orange Pi PC 2, power on, and let REG Linux expand the filesystem. Pair controllers inside EmulationStation once prompted.
...
- REG Linux download page: https://reglinux.org/download/orange-pi-pc-2/

- Official REG Linux board page: https://reglinux.org/board/orange-pi-pc-2
