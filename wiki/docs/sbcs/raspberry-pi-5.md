...
| SoC | CPU | GPU |
| --- | --- | --- |
| Broadcom BCM2712 | ARM Cortex-A76 (Quad-core) | VideoCore VII |
...
1. Grab the image. Download the latest Raspberry Pi 5 build from the downloads page or the official board entry .
...
3. First boot setup. Insert the media into your Raspberry Pi 5, power on, and let REG Linux expand the filesystem. Pair controllers inside EmulationStation once prompted.
...
- REG Linux download page: https://reglinux.org/download/raspberry-pi-5/

- Official REG Linux board page: https://reglinux.org/board/raspberry-pi-5
