...
description: Orange Pi Zero 3 pairs the Allwinner H618 SoC with the REG Linux stack for a polished retro console.
generated: 2026-03-18 22:56:02
---

# Orange Pi Zero 3

Orange Pi Zero 3 pairs the Allwinner H618 SoC with the REG Linux stack for a polished retro console.


## Hardware & Compatibility

<div data-reg-compat="orange-pi-zero-3:specs"></div>
<script src="https://compat.reglinux.org/widget.js"></script>

## Installation notes

1. Grab the image. Download the latest Orange Pi Zero 3 build from the downloads page.
