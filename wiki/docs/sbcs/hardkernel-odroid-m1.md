...
HardKernel ODROID M1 pairs the Rockchip RK3568 SoC with the REG Linux stack for a polished retro console.


## Hardware & Compatibility

<div data-reg-compat="hardkernel-odroid-m1:specs"></div>
<script src="https://compat.reglinux.org/widget.js"></script>

## Installation notes

1. Grab the image. Download the latest HardKernel ODROID M1 build from the downloads page.
...
- REG Linux download page: https://reglinux.org/download/hardkernel-odroid-m1/
