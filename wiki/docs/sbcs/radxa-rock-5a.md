---
title: Radxa Rock 5A
description: Radxa Rock 5A pairs the Rockchip RK3588 SoC with the REG Linux stack for a polished retro console.
generated: 2026-03-18 22:56:02
---

# Radxa Rock 5A

Radxa Rock 5A pairs the Rockchip RK3588 SoC with the REG Linux stack for a polished retro console.


## Hardware & Compatibility

<div data-reg-compat="radxa-rock-5a:specs"></div>
<script src="https://compat.reglinux.org/widget.js"></script>

## Installation notes

1. Grab the image. Download the latest Radxa Rock 5A build from the downloads page.
