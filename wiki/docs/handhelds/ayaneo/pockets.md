---
title: AYANEO Pocket S
description: REG Linux on AYANEO Pocket S powered by Qualcomm 8gen2 (SM8550).
manufacturer: AYANEO
slug: ayaneo/pockets
...
| SoC | CPU | GPU |
| --- | --- | --- |
| Qualcomm 8gen2 (SM8550) | ARM Cortex-X3 | Adreno (Freedreno) |
...
| --- | --- | --- | --- |
| Mainline Linux | — | Sway | REG-ES |

## Features

| Feature | Notes |
| --- | --- |
| Storage | REG Linux can be run from an SD Card. |
