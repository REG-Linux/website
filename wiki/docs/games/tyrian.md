...
<img src="/wiki/assets/systems/icons/tyrian.webp" alt="Tyrian icon" width="96" height="96" loading="lazy" style="border-radius:12px; object-fit:contain; background:#0f172a; padding:.25rem;">
<span style="display:flex; align-items:center; justify-content:center; background:#050505; padding:.35rem 0.75rem; border-radius:0.75rem;"><img src="/wiki/assets/systems/logos/tyrian.png" alt="Tyrian logo" loading="lazy" style="max-height:96px; object-fit:contain;"></span>
</div>
...
The native Tyrian binary uses the provided data. It respects the standard Quick Menu overrides (`[HOTKEY]` + south button) for video scaling, shaders, and controller remapping. Toggle fullscreen, adjust aspect, or remap keys from that menu if necessary.
